...
const nurseOlynyk5 = new Nurse('Olynyk', ['Trauma', 'Pediatrics']);
nurseOlynyk5.takeVacationDays(5);
console.log(nurseOlynyk5.remainingVacationDays);
nurseOlynyk5.addCertification('Genetics');
console.log(nurseOlynyk5.certifications);
